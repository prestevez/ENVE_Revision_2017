...
enve_model$extortions[which(enve_model$subsector == "Other")] <- c(rep(1, 5), rep(0, 5))
...
binary_formula <- as.formula("extortion_victim ~ 
                            bribes + 
                            yearsquant + 
                            subsector + 
                            size + 
...
- fully specified: ZINB vs MNB vs ZIP
- null: ZINB vs NB
- No state: ZINB vs NB
- No bus: ZINB vs NB
...
- count: business bribe, zero: state bribe
...
- Move on to models ZIP and hurdle models
- Test
- Send
