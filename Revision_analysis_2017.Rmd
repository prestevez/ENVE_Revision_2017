...
nullind <- which(unlist(lapply(ext_est_chisq_p, is.null)))

ext_est_chisq_p <- ext_est_chisq_p[-nullind]
...
nullind <- which(unlist(lapply(ext_est_chisq_nb, is.null)))

ext_est_chisq_nb <- ext_est_chisq_nb[-nullind]
...
chisq_list(batch_iqvs, option = "observed", print_option = "pandoc")

chisq_list(batch_iqvs, option = "ratio", print_option = "pandoc")

chisq_list(batch_iqvs, option = "percent", print_option = "pandoc")
...
- n business
- n victims (extortion and bribery)
- n repeat victims
- n incidents
- n repeat incidents
- Gini index per state (for all and for business)
- plot of lorenz curve per state


```{r state-level-summary}
