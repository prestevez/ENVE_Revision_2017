...
```r
tcmp1 <- tryCatch(summary(mp1), error = function(e) e)

if(is(tcmp1, "error"))
{
    mp1 <- glmer(count_formula, data = enve_model, family = "poisson")
} else {print("mp1 was fitted correctly with glmmadmb")}
...
```r
tcmp1 <- tryCatch(summary(mp_final), error = function(e) e)

if(is(tcmp1, "error"))
{
    mp_final <- glmer(formula(mnb_final), data = enve_model, family = "poisson")
} else {print("mp_final was fitted correctly with glmmadmb")}
```
